...
t_measure = np.load(open(os.path.join(DATA_DIR, "%s_t_measure.npy"%label), "rb"),allow_pickle=True)
...
cp = np.load(open(os.path.join(DATA_DIR, "cp.npy"), "rb"),allow_pickle=True)
